...
model_output = {
    "version": "v12-longform-100",
    "type": "binary_classification_gbt",
    "description": "ヒット予測モデル v12-longform-100 — ep1 の表層特徴から長編化(>=100話)を予測",
    "target": "is_longform (totalEpisodes >= 100)",
...
output_path = MODELS / "hit-prediction-v12-longform-100.json"
