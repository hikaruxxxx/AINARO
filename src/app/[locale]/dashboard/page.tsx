  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-gray-900">{t("myNovels")}</h1>
      ...
      {myNovels.length === 0 ? (
        <div className="rounded-xl border border-dashed border-gray-300 bg-white py-16 text-center">
          ...
          <p className="mt-4 text-sm font-medium text-gray-900">{t("noNovels")}</p>
          <p className="mt-1 text-sm text-gray-500">{t("noNovelsHint")}</p>
          <Link
            href="/dashboard/novels/new"
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {myNovels.map((novel) => {
            ...
            return (
              <div
                key={novel.id}
                className="group flex flex-col rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition hover:border-indigo-200 hover:shadow-md:border-indigo-800"
              >
                <Link href={`/dashboard/novels/${novel.id}`} className="flex-1">
                  ...
                  <h3 className="mb-1 font-bold text-gray-900 group-hover:text-indigo-600 line-clamp-2">
                    {novel.title}
                  </h3>
