...
function specs(slug: string, episode: number): LayerSpec[] {
  ...
  return [
    ...
    { id: "L03", label: "L03 Shotlist", artifacts: [artifact(shotlist, "file")], next_view: "name-gate", next_layer_id: null },
    { id: "L04", label: "L04 Storyboard", artifacts: [artifact(storyboardPath(slug, episode), "file")], next_view: "name-gate", next_layer_id: null },
    {
      id: "L04_1",
    ...
    { id: "L05", label: "L05 Page Director", artifacts: [artifact(pagePlanPath(slug, episode), "file")], next_view: "name-gate", next_layer_id: null },
    { id: "L06", label: "L06 Continuity", artifacts: [artifact(pagePlanPath(slug, episode), "file")], next_view: "name-gate", next_layer_id: null },
    { id: "L07", label: "L07 Refs Resolution", artifacts: [artifact(resolvedRefsPath(slug, episode), "file")], next_view: "name-gate", next_layer_id: null },
    { id: "L08", label: "L08 Incremental Refs", artifacts: [artifact(incrementalRefsDir(slug, episode), "dir")], next_view: "name-gate", next_layer_id: null },
