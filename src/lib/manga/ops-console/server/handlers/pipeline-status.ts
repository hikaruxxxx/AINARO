...
function specs(slug: string, episode: number): LayerSpec[] {
  ...
  return [
    ...
    { id: "L05", label: "L05 Page Director", artifacts: [artifact(pagePlanPath(slug, episode), "file")], next_view: "assets", next_layer_id: null },
    { id: "L06", label: "L06 Continuity", artifacts: [artifact(pagePlanPath(slug, episode), "file")], next_view: "assets", next_layer_id: null },
    { id: "L07", label: "L07 Refs Resolution", artifacts: [artifact(resolvedRefsPath(slug, episode), "file")], next_view: "assets", next_layer_id: null },
    { id: "L08", label: "L08 Incremental Refs", artifacts: [artifact(incrementalRefsDir(slug, episode), "dir")], next_view: "assets", next_layer_id: null },
