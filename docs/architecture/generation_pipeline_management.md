...
> **Phase 1 についての注意**: 本文書は v1 の前身設計です。Phase 1 の生成パイプライン、Layer 1〜6、階層キュー、ペアワイズ評価、探索枠、訓練データ保存の正典は `docs/architecture/phase1_pipeline_design_v2.md` です。本書内の `/screen-mass`、バッチ中心管理、LLM 6軸絶対スコア、v10/v11 前提は Phase 1 では旧仕様として扱います。
